...
class CustomCalloutView: UIView, MGLCalloutView {
    ...
    required init(representedObject: MGLAnnotation) {
        ...
        mainBody.setTitle(representedObject.coordinate.latitude.description, for: .normal)
    ...
    func presentCallout(from rect: CGRect, in view: UIView, constrainedTo constrainedRect: CGRect, animated: Bool) {
        ...
        // Prepare title label.
        guard let title = representedObject.title
        else { return }
        
        mainBody.setTitle(title, for: .normal)
        mainBody.sizeToFit()
